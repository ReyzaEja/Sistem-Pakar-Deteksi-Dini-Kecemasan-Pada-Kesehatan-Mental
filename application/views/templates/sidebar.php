  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3">
      <div class="d-flex mt-2">
        <div class="info">
          <p class="text-center font-weight-bold">Sistem Pakar Deteksi <br> Dini Gangguan Kecemasan</p>
        </div>
      </div>
      <hr style="color: black !important;">
      <div class="d-flex">
        <?php if ($this->session->userdata('sess_role_id') == false) : ?>
          <div class="image">
            <img src="<?= base_url('assets/profil/default.jpg'); ?>" class="img-circle elevation-2" alt="User Image">
          </div>
        <?php else : ?>
          <div class="image">
            <img src="<?= base_url('assets/profil/') . $users['gambar']; ?>" class="img-circle elevation-2" alt="User Image">
          </div>
        <?php endif; ?>
        <div class="info" style="color: #252525; !important">
          <?php if ($this->session->userdata('sess_user_id')) : ?>
            <?php if ($this->session->userdata('sess_role_id') == 1) : ?>
              <a href="profil" class="d-block" style=" color: #252525; !important"><?= $users['nama_lengkap']; ?></a>
