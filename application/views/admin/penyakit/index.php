...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Gangguan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-10 mx-auto">
          <h3 class="text-center">Master Data Gangguan</h3>
                ...
                <div class="card-body">
                  <table style="width: 100%" class="table table-striped tabled-bordered">
                    <thead>
                      ...
                      <th style="width: 30%">Nama Gangguan</th>
                      ...
                      <?php foreach ($penyakit as $p) : ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?= base_url('Admin/penyakit/delete/') . $p['id'] ?>" class="badge badge-sm badge-danger badge-pill" onclick="return confirm('apakah anda yakin?');">Hapus</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/penyakit/add') ?>" method="post">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Keterangan Gangguan</label>
            <textarea name="keterangan" class="form-control" required></textarea>
          </div>
          <div class="form-group">
            <label>Solusi Gangguan</label>
