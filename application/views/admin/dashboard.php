      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-6">
          <div class="small-box" style="background-color: #C3B1E1;">
            ...
            <a href="akun/member" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <div class="col-lg-6 col-6">
          <div class="small-box" style="background-color: #FDFD96;">
            ...
            <a href="akun/pakar" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
          </div>
        </div>
      </div>
