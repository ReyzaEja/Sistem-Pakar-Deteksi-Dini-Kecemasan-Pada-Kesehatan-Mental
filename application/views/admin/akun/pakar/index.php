                    ...
                    <tbody>
                      ...
                      <?php foreach ($user as $u) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="#!" class="badge badge-sm badge-primary badge-pill" data-toggle="modal" data-target="#detailModal" role="button" onclick="showDetail(this)" id-pakar="<?= $u['id'] ?>">detail</a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('admin/akun/pakar/update') ?>" method="post">
        <div class="modal-body">
...
<script type="text/javascript">
  ...
  const showDetail = async (target) => {
    ...
    const id = target.getAttribute('id-pakar');
    console.log('id :', id);
    ...
    if (user) {
      ...
      document.getElementById('hapus_edit').setAttribute('id-pakar', user.id);
    }
  }
  ...
  const hapusAkun = (target) => {
    // console.log(target.getAttribute('id-pakar'));
    const id = target.getAttribute('id-pakar');
    window.location = "<?= base_url('admin/akun/pakar/delete/') ?>" + id;
  }
</script>